...
TEST(rotateRight, 0){
  BST a;
  a.insert("bob");
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "bob");
  EXPECT_EQ(a.size(), 1);
  a.rotateRootRight();
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "bob");
  EXPECT_EQ(a.size(), 1);
...
TEST(rotateRight, 1){
  ...
  a.insert("alice");
  a.insert("chuck");
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "bob alice chuck");
  EXPECT_EQ(a.size(), 3);
  a.rotateRootRight();
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "alice bob chuck");
  EXPECT_EQ(a.size(), 3);
}
...
TEST(rotateRight, 2){
  ...
  a.insert("bob");
  a.insert("alice");
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "bob alice");
  EXPECT_EQ(a.size(), 2);
  a.rotateRootRight();
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "alice bob");
  EXPECT_EQ(a.size(), 2);
...
TEST(rotateRight, 3){
  ...
  a.insert("alice");
  a.insert("clem");
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "dave bob alice clem frank eva ginny");
  EXPECT_EQ(a.size(), 7);
  a.rotateRootRight();
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "bob alice dave clem frank eva ginny");
  EXPECT_EQ(a.size(), 7);
}
...
TEST(rotateLeft, 1){
  ...
  EXPECT_EQ(a.size(), 3);
  a.rotateRootLeft();
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "chuck bob alice");
  EXPECT_EQ(a.size(), 3);
}
...
TEST(rotateLeft, 3){
  ...
  EXPECT_EQ(a.size(), 7);
  a.rotateRootLeft();
  EXPECT_EQ(cleanString( a.preOrderTraversal() ), "frank dave bob alice clem eva ginny");
  EXPECT_EQ(a.size(), 7);
}
/*
TEST(balance, lineright3){
  BST a;
  a.insert("alice"); 
  a.insert("bob"); 
  a.insert("clem"); 
